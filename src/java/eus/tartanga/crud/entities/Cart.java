...
/**
 * @NamedQueries({
 * @NamedQuery(name="findAllProductsPurchased",query="SELECT * FROM CART WHERE
 * BOUGHT LIKE TRUE"),
 * @NamedQuery(name="findAllProductsNotPurchased",query="SELECT * FROM CART
 * WHERE BOUGHT LIKE FALSE"), }) *
 */
@Entity
